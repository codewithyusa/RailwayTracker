...
public static class DataSeeder
{
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        {
            new() { Name = "Torhailoch",            Code = "TOR", Latitude = 9.0140, Longitude = 38.7140, StopOrder = 1,  LineId = green.Id },
            new() { Name = "CocaCola",              Code = "COC", Latitude = 9.0148, Longitude = 38.7242, StopOrder = 2,  LineId = green.Id },
            new() { Name = "St. Lideta",            Code = "SLD", Latitude = 9.0155, Longitude = 38.7358, StopOrder = 3,  LineId = green.Id },
        ...
        var blueStations = new List<Station>
        {
            ...
            new() { Name = "Sebategna",         Code = "SBT", Latitude = 9.0230, Longitude = 38.7478, StopOrder = 5,  LineId = blue.Id },
            new() { Name = "Abnet",             Code = "ABN", Latitude = 9.0165, Longitude = 38.7468, StopOrder = 6,  LineId = blue.Id },
            new() { Name = "Darmar",            Code = "DRM", Latitude = 9.0100, Longitude = 38.7455, StopOrder = 7,  LineId = blue.Id },
        ...
        var trains = new List<Train>
        {
            ...
            new() { Code = "G-03", Name = "Green 03", LineId = green.Id, IsActive = false, Status = TrainStatus.Cancelled, LastUpdated = DateTime.UtcNow, Latitude = 9.0140, Longitude = 38.7140 },
