...
public static class DataSeeder
{
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        // Blue Line: Menilik Square (north) → Kaliti (south) — straight south along real road
        var blueStations = new List<Station>
        {
            ...
            // South section — goes straight south, NOT southwest
            new() { Name = "Meshwalekya",    Code = "MWB", Latitude = 8.9990, Longitude = 38.7620, StopOrder = 15, LineId = blue.Id },
            new() { Name = "Riche",          Code = "RCH", Latitude = 8.9920, Longitude = 38.7608, StopOrder = 16, LineId = blue.Id },
            new() { Name = "Temenja Yazh",   Code = "TMJ", Latitude = 8.9845, Longitude = 38.7595, StopOrder = 17, LineId = blue.Id },
            new() { Name = "Lancha",         Code = "LNC", Latitude = 8.9768, Longitude = 38.7580, StopOrder = 18, LineId = blue.Id },
            new() { Name = "Nifas Silk 1",   Code = "NF1", Latitude = 8.9693, Longitude = 38.7565, StopOrder = 19, LineId = blue.Id },
            new() { Name = "Nifas Silk 2",   Code = "NF2", Latitude = 8.9618, Longitude = 38.7552, StopOrder = 20, LineId = blue.Id },
            new() { Name = "Adey Abebe",     Code = "ADB", Latitude = 8.9543, Longitude = 38.7538, StopOrder = 21, LineId = blue.Id },
            new() { Name = "Saris",          Code = "SRS", Latitude = 8.9468, Longitude = 38.7525, StopOrder = 22, LineId = blue.Id },
            new() { Name = "Abo Junction",   Code = "ABJ", Latitude = 8.9393, Longitude = 38.7512, StopOrder = 23, LineId = blue.Id },
            new() { Name = "Kaliti",         Code = "KLT", Latitude = 8.9318, Longitude = 38.7498, StopOrder = 24, LineId = blue.Id },
        };
        ...
        var trains = new List<Train>
        {
            ...
            new() { Code = "B-02", Name = "Blue 02",  LineId = blue.Id,  IsActive = true,  Status = TrainStatus.Delayed,   LastUpdated = DateTime.UtcNow, Latitude = 8.9618, Longitude = 38.7552 },
            new() { Code = "B-03", Name = "Blue 03",  LineId = blue.Id,  IsActive = false, Status = TrainStatus.Cancelled, LastUpdated = DateTime.UtcNow, Latitude = 8.9318, Longitude = 38.7498 },
        };
