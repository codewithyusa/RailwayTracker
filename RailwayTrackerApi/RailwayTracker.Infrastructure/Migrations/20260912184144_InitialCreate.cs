        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcements_Stations_StationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Arrivals_Stations_StationId",
                        column: x => x.StationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Arrivals_Trains_TrainId",
                        column: x => x.TrainId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_StationId",
                table: "Announcements",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_Arrivals_StationId",
                table: "Arrivals",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_Arrivals_TrainId",
                table: "Arrivals",
                column: "TrainId");
